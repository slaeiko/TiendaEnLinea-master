...
function valida() {
    ...
    if (nombre === "" || descripcion === "" || costo === "" || stock === "" || codigo === "" || foto === "") {
...
<div class="display-6" style="color: white;">Alta de productos</div>
<div class="detalle-item"><a href="productos_lista.php" class="btn-regresar btn btn-outline-light">Regresar al listado </a></div>
<form name="forma01" method="post" enctype="multipart/form-data" action="productos_salva.php">
    ...
    <div class="detalle-item">
        ...
        <input type="text" id="codigo" name="codigo" onblur="validarCodigo();">
    </div>
    <div class="detalle-item">
